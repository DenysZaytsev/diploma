...
- Name: smoke.spec.ts >> Mini-EDMS Smoke Tests >> Shows error message on invalid login attempt
...
Locator: locator('div.text-red-600')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('div.text-red-600')
