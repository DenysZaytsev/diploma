...
const DepartmentModal: React.FC<DepartmentModalProps> = ({ 
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      title={department ? 'Редагувати відділ' : 'Додати новий відділ'}
      footer={
        <>
          <button
            type="button"
    ...
    >
      <form id="dept-form" onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label className="block text-sm font-bold text-slate-700 mb-1">Назва відділу *</label>
          <input
            type="text"
            required
            autoFocus
            ...
            placeholder="Напр. Фінансовий відділ"
